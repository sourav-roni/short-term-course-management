...
public class adCoord extends JFrame {
	 ...
	 * Create the frame.
	 */
	public adCoord(final ArrayList<Course> courseArray,final int index) {
		setTitle("Alter Course Co-ordinator");
		setResizable(false);
		...
		textField.setText(courseArray.get(index).courseCoordinator.facultyName);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(389, 70, 242, 25);
		textField_1.setText(courseArray.get(index).courseCoordinator.affiliatedDepartment);
		contentPane.add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(389, 120, 242, 25);
		textField_2.setText(courseArray.get(index).courseCoordinator.facultyAddress);
		contentPane.add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(389, 162, 242, 25);
		textField_3.setText(courseArray.get(index).courseCoordinator.mobile);
		contentPane.add(textField_3);
		
		textField_4 = new JTextField();
		textField_4.setColumns(10);
		textField_4.setBounds(389, 207, 242, 25);
		textField_4.setText(courseArray.get(index).courseCoordinator.email);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(done==true){
					...
					setVisible(false);
					JOptionPane.showMessageDialog(null, "Changes to Course Co-ordinator Successfully Saved!!");
				}
			}
		});
		btnNewButton.setBounds(125, 295, 162, 25);
		...
		btnNewButton_1.setBounds(389, 295, 156, 25);
